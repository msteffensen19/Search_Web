Action()
{
	...
	// 3. Search for Roar and hit Return
	// 4. Click on Roar mini
	// 5. Click on the Search icon (magnifying glass)
	// 6. Search for Bose and hit Return
	// 7. Click on Bose Wireless
	// 8. Click Home
	//
	// Two transactions are available - AOS_Home, AOS_Search
